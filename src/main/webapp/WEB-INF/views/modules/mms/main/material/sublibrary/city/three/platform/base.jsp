    ...
    <div class="divMaterialLoadAlert_bottom  pt10 plr10 boldTopLine">
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <a v-show="matTreeBase.scorePara != 0 && matTreeBase.scoreBase != 0" href="javascript:" class="circlemark circlemark-green">完</a>
                <a v-show="matTreeBase.scorePara == 0 || matTreeBase.scoreBase == 0" href="javascript:" class="circlemark circlemark-lightRed">未</a>
            </div>
        </div>
