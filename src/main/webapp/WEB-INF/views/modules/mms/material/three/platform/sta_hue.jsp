                ...
                <div class="analyItem">
                    ...
                    <div class="analyItemCon relative">
                        <div class="analyItemsubTitle mb20">
                            <label class="uiRadio12 mt5"><input type="checkbox" name="b" class="uiRadio12-input">全选</label>
                            <div class="fr">
    ...
    <div class="divMaterialLoadAlert_bottom pt10 plr10 boldTopLine">
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <a v-show="matHueSta.loopStatus == 1" href="javascript:" class="circlemark circlemark-green">1</a>
                <a v-show="matHueSta.loopStatus == 0" href="javascript:" class="circlemark circlemark-lightRed">0.5</a>
            </div>
        </div>
    </div>
