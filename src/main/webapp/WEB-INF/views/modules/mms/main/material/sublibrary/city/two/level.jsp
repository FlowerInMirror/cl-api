...
<div class="analyItem">
    ...
    <div class="analyItemCon clearfix relative">
        ...
        <a ng-show="two_level.levelTotalLoopScore == 1" href="javascript:" class="circlemark circlemark-green">完</a>
        <a ng-show="two_level.levelTotalLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
    </div>
</div>
...
<div class="analyItem anItemBor" data-ptype="standard" data-type="33">
    ...
    <div class="analyItemCon">
        ...
        <a ng-show="two_level.qualityStandardLoopScore == 1" href="javascript:" class="circlemark circlemark-green">完</a>
        <a ng-show="two_level.qualityStandardLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
    </div>
</div>
...
<div ng-repeat="level in two_level.brandMaps track by $index" ng-click="setHideMatID(level.matID)" class="analyItem anItemBor relative" id="{{'brand' + level.matID}}" data-ptype="brand" data-matid="{{level.matID }}" data-first="{{two_level.currentLevel == 2 && $index == 0 ? 1 : 0}}">
    ...
    <div class="analyItemCon pinpai">
        ...
        <a ng-show="level.brandLooopScore == 1" href="javascript:" class="circlemark circlemark-green">完</a>
        <a ng-show="level.brandLooopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
    </div>
</div>
<script>
    //    $(function () {
