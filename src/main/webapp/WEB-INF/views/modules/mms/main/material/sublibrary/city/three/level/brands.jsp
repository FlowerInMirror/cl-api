    ...
    <div class="brandsShowBox plr10">
        <div class="brandsShow clearfix mt10 relative">
            ...
            <div class="slide_img_info relative">
                ...
                <span class="cRed ml15 slidePriceBrnad">￥{{matLevelBrands.mQuotesPrice | holdTwoDecimal(matLevelBrands.mQuotesPrice )}}</span>
                    ...
                    <div class="analyItem">
                        ...
                        <div class="analyItemCon relative">
                            ...
                            <p class="info-look fl col-md-4">
                                ...
                                <span id="spanQuotesPrice">￥{{matLevelBrands.mQuotesPrice | holdTwoDecimal(matLevelBrands.mQuotesPrice)}}</span>
                            </p>
                            <p class="info-edit hide fl col-md-4 ">
                                <span class="cLightGray pr8 justify_span justify_span_w80">报价</span>
                            ...
                            <p class="info-look fl col-md-4">
                                ...
                                <span id="spanCostPrice">￥{{matLevelBrands.mCostPrice | holdTwoDecimal(matLevelBrands.mCostPrice)}}</span>
                            </p>
                            <p class="info-edit hide fl col-md-4 ">
                                <span class="cLightGray pr8 justify_span justify_span_w80">成本</span>
                            ...
                            <%--安装价(成品类展示)--%>
                            <p v-show="matLevelBrands.classify == 1" :class="matLevelBrands.classify == 1 ? 'info-look fl col-md-4' : 'fl col-md-4' ">
                                <span class="cLightGray pr8 justify_span justify_span_w80">安装/加工费</span>
                                <span id="spanInstallPrice">￥{{matLevelBrands.mInstallPrice | holdTwoDecimal(matLevelBrands.mInstallPrice)}}</span>
                            </p>
                            <p :class="matLevelBrands.classify == 1 ? 'info-edit hide fl col-md-4' : 'hide fl col-md-4 feiChengPin'" >
                                <span class="cLightGray pr8 justify_span justify_span_w80">安装/加工费</span>
                            ...
                            <div class="dis-il-block imgbox hide imgbox2">
                                <img class="save_img btnSaveBrandSupOption" data-type="3" src="${ctxStatic}/images/pic/save_img.png" />
                                <img class="goback_img" src="${ctxStatic}/images/pic/goback_img.png" />
                            </div>
        ...
        <div class="divMaterialLoadAlert_bottom pt10 plr10 boldTopLine">
            ...
            <div class="analyItem">
                ...
                <div class="analyItemCon">
                    ...
                    <a v-show="matLevelBrands.brandInfoLoop == 1 && matLevelBrands.typeInfoLoop == 1 " href="javascript:" class="circlemark circlemark-green">完</a>
                    <a v-show="matLevelBrands.brandInfoLoop == 0 || matLevelBrands.typeInfoLoop == 0 " href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="tx-center mt10 pb5">
                ...
                <input type="button" value="删除" class="uiBtn-small uiBtn-red btnBrandDelete">
                <input v-show="matLevelBrands.mShoppingState == 0" type="button" value="预下架" class="uiBtn-small uiBtn-gray btrandPreloadFrame" data-type="2">
                <input v-show="matLevelBrands.mShoppingState == 2" type="button" value="取消预下架" class="uiBtn-small uiBtn-green btrandPreloadFrame" data-type="0">
