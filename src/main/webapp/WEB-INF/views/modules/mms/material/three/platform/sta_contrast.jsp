    ...
    <div class="divMaterialLoadAlert_bottom pt10 plr10 boldTopLine">
        <div class="analyItem">
            ...
            <div class="analyItemCon">
                ...
                <a v-show="matContrastSta.totalScore != 0" href="javascript:" class="circlemark circlemark-green">1</a>
                <a v-show="matContrastSta.totalScore == 0" href="javascript:" class="circlemark circlemark-lightRed">0.5</a>
            </div>
        </div>
