...
<div class="tc-center fl tc-center-mat">
    <ul class="clearfix uiTab9 j_uiTab9">
        ...
        <%--平台更名规格--%>
        <li ng-click="cityTwoPlatform(hidTreeID)" class="nvTwoPlatform">平台</li>
    ...
    <div id="j-tc-center-content" class="pr10">
        ...
        <div class="uiTab9Con" id="divMaterialDetailToStatus">
            ...
            <div class="analyItem anItemBor" onclick="(function(){$('.nvTwoPlatform').click()})()">
                ...
                <div class="analyItemCon relative" >
                    ...
                    <a ng-show="hidPlatformLoopStatus == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="hidPlatformLoopStatus == 0" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem">
            ...
            <div ng-show="aLevelShowFlag != 0" class="analyItem anItemBor" data-level="1">
                ...
                <div class="analyItemCon relative">
                    ...
                    <a ng-show="two_state.aLevel.levelTotalLoopScore == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_state.aLevel.levelTotalLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            ...
            <div ng-show="bLevelShowFlag != 0" class="analyItem anItemBor" data-level="2">
                ...
                <div class="analyItemCon relative">
                    ...
                    <a ng-show="two_state.bLevel.levelTotalLoopScore == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_state.bLevel.levelTotalLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            ...
            <div ng-show="cLevelShowFlag != 0" class="analyItem anItemBor" data-level="4">
                ...
                <div class="analyItemCon relative">
                    ...
                    <a ng-show="two_state.cLevel.levelTotalLoopScore == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_state.cLevel.levelTotalLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
        ...
        <div class="uiTab9Con dis-none" id="divMaterialDetailToBase"  >
            <div class="analyItem">
                ...
                <div class="analyItemCon clearfix">
                    ...
                    <a ng-show="two_platform.statusFlag == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.statusFlag == 0" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem anItemBor baseinfo">
                ...
                <div class="analyItemCon">
                    ...
                    <a ng-show="two_platform.matBaseFalg == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.matBaseFalg == 0" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem anItemBor standardinfo" data-type="1">
                ...
                <div class="analyItemCon">
                    ...
                    <a ng-show="two_platform.qualityStandard.qualitySize >= 4" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.qualityStandard.qualitySize < 4" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem anItemBor standardinfo" data-type="3">
                ...
                <div class="analyItemCon">
                    ...
                    <a ng-show="two_platform.sampleStandard.samplingMethod != '无' && two_platform.sampleStandard.acceptanceStandard > 0" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.sampleStandard.samplingMethod == '无' && two_platform.sampleStandard.acceptanceStandard == '无'" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem anItemBor standardinfo" data-type="4">
                ...
                <div class="analyItemCon">
                    ...
                    <a ng-show="two_platform.packStaLoop == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.packStaLoop == 0" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem anItemBor standardinfo" data-type="66">
                ...
                <div class="analyItemCon">
                    ...
                    <a ng-show="two_platform.contrastStandard.contrastItem  != '无'" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.contrastStandard.contrastItem  == '无'" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            <div class="analyItem anItemBor standardinfo" data-type="50" data-opertype="update">
                ...
                <div class="analyItemCon">
                    ...
                    <a ng-show="two_platform.searchTerm.searchTerm  > 0 && two_platform.searchTerm.use >  0" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a ng-show="two_platform.searchTerm.searchTerm  == '无' && two_platform.searchTerm.use == '无'" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
        </div>
        <!--平台 结束-->
        ...
        <!--商城-->
        <%--TODO 三段弹出未实现 data-ptype="settop-Hide" 统一加后缀 - Hide 实现避免 --%>
        <div class="uiTab9Con dis-none" id="divMaterialDetailToPlatform">
            ...
            <div class="analyItem anItemBor" data-ptype="settop-Hide">
                <p class="analyItemTit tx-center">商城</p>
                <div class="analyItemCon">
            ...
            <div class="analyItem anItemBor" data-ptype="search-Hide" data-opertype="look">
                <p class="analyItemTit tx-center">搜索词</p>
                <div class="analyItemCon">
            ...
            <div class="analyItem anItemBor" data-ptype="photo-Hide">
            ...
            <div class="analyItem anItemBor" data-ptype="comparedHide-Hide">
            ...
            <div class="analyItem anItemBor" data-ptype="standard-Hide" data-type="1">
                <p class="analyItemTit tx-center">质量标准</p>
                <div class="analyItemCon">
...
<script>
    $(function () {
        $(".mater_lists:not(.emMatList)").click(function () {
            $('.iframe_list').css({
                "position": "fixed",
                "left": '0',
                "top": '0',
            ...
            // 根据地区判断区别:集团 与 工程经理.材料
            if (userCityID != 39) $('.iframe_list').css("background","#fff").attr('src', basePath + '/em/material-web/open-list');
            else $('.iframe_list').attr('src', basePath + '/public-web/material/list');
            $('.iframe_list').show();
            $(".iframe_list_01").show();
