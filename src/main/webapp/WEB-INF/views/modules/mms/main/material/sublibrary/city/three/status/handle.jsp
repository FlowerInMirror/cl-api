        ...
        <div class="SearchCon  pt10 plr10">
            ...
            <div class="analyItem cl_zh">
                ...
                <div class="analyItemCon">
                    ...
                    <a v-show="platform.platformLoopStatus == 1" href="javascript:" class="circlemark circlemark-green">完</a>
                    <a v-show="platform.platformLoopStatus != 1" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            ...
            <div class="analyItem cl_zh">
                ...
                <div class="analyItemCon">
                    ...
                    <a v-show="aLevel.levelTotalLoopScore == 1" href="javascript:" class="circlemark circlemark-green ">完</a>
                    <a v-show="aLevel.levelTotalLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
            ...
            <div class="analyItem cl_zh">
                ...
                <div class="analyItemCon">
                    ...
                    <a v-show="cLevel.levelTotalLoopScore == 1" href="javascript:" class="circlemark circlemark-green ">完</a>
                    <a v-show="cLevel.levelTotalLoopScore == 0.5" href="javascript:" class="circlemark circlemark-lightRed">未</a>
                </div>
            </div>
